...
const fireservice_1 = __importDefault(require("../populate/fireservice"));
const health_1 = __importDefault(require("../populate/health"));
const router = (0, express_1.Router)();
router.post("/state", state_1.default);
router.post("/lga", lgas_1.default);
router.post("/health", health_1.default);
router.post("/fireservice", fireservice_1.default);
