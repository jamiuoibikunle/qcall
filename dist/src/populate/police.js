...
const police = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        lgas.map((item) => __awaiter(void 0, void 0, void 0, function* () {
            yield database_1.default.query("INSERT INTO police (state, local_government) VALUES ($1, $2)", [item.state, item.name]);
        }));
