...
const fireservice = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        lgas.map((item) => __awaiter(void 0, void 0, void 0, function* () {
            yield database_1.default.query("INSERT INTO fire_service (state, local_government) VALUES ($1, $2)", [item.state, item.name]);
        }));
        return res
            .status(200)
            .json({ status: true, results: "Populated fire service" });
    }
    catch (error) {
